...
const { ApplyForIntern, appliedInterns, approveIntern, rejectIntern, detailedApplication, facultyInterships, postInternship, getAllAvaliableInternships, getDetailedIntershipDetails } = require('../controllers/application');
