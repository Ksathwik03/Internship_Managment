...
const { ApplyForIntern, appliedInterns, approveIntern, detailedApplication, facultyInterships, postInternship, getAllAvaliableInternships } = require('../controllers/application');
